...
# 1. LOAD THE DATA (Updated to node3)
df = pd.read_csv('analysis_node3.csv')

# 2. SETUP OUTPUT (Updated folder name)
output_folder = 'boxplots_node3'
if not os.path.exists(output_folder):
    os.makedirs(output_folder)

# 3. SETTINGS
# Removed 'green' and 'bare' to focus on 'glyphosate' and 'mechanical'
custom_order = ['glyphosate', 'mechanical']
color_palette = {'mechanical': 'orange', 'glyphosate': 'red'}
...
for idx in indices:
    for stat in stats:
        ...
        # DETAIL ADJUSTMENT: Add minor grid lines
